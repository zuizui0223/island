...
This repository's **current publication-facing surface is Chapter 1 v13**. The active paper is a global-only **H1–H4** synthesis. Earlier Chapter 1 hypothesis ladders, defended submission states and submission-surface audits are historical provenance, not the current scientific spine.

## 1. Current scientific claim

The v13 paper tests one integrated idea:

> **Geographic isolation is associated globally with a recurrent floral/reproductive island-syndrome direction and with stronger experimental pollen limitation, while plants express the syndrome through partially separable reproductive-assurance and floral-accessibility pathways.**

The four geographic strata are replication strata for recurrence of direction. The current submission does not require or promote between-stratum differences.

## 2. Current H1–H4 architecture

1. **H1 — recurrent global island syndrome.** Six identically oriented floral/reproductive responses show supported multivariate isolation responses in all four predeclared geographic replication strata, with a positive descriptive classic-island direction in both evidence scopes.
...
3. **H3 — dual plant pathways.** Reproductive assurance and floral accessibility/generalization recur as partially separable response families rather than one obligatory selfing-to-simplification sequence.
...
5. [`docs/chapter1_unified_hypothesis_20260917.md`](docs/chapter1_unified_hypothesis_20260917.md) — biological hypothesis and evidence map;
6. [`docs/chapter1_submission_freeze_v13_20260917.md`](docs/chapter1_submission_freeze_v13_20260917.md) — current submission freeze.
...
v13 combines three evidence layers:

- **plant-side recurrence:** isolation-associated floral/reproductive response vectors across four geographic replication strata;
...
The audit runs for changes targeting `main` and checks the repository suite, v13 linting, the v13-only paper surface and preservation of frozen historical provenance.

## 7. Chapter 1 / Chapter 2 handoff

Chapter 1 establishes the global pattern: recurrent floral/reproductive change with isolation, an independent pollen-limitation gradient, and partially separable reproductive-assurance and floral-accessibility responses. It does not identify the historical causal sequence.

Chapter 2 (`izu-core`) is the mechanistic-resolution layer and can test the within-system chain:
