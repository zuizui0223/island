> **HISTORICAL / SUPERSEDED — pre-v13 explanation-gap program.** This document describes a pre-corrected Chapter 1 design and is retained only for provenance/replay. It is **not** a current scientific or submission contract. Use `config/chapter1_submission_current.json`, `submission/chapter1_current/MANUSCRIPT.md`, and `docs/PAPER_PIPELINE.md` for the current H1–H4 surface.
