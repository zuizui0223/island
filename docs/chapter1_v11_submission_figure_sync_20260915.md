...
Canonical P3 result lock: `config/chapter1_p3_joint_observation_bias_result_lock.json`

## Figure 4 — P3 joint observation-bias boundaries

Canonical lock: `config/chapter1_v11_figure4_result_lock.json`

- run `34959336481`;
- artifact `10393100040`;
- digest `sha256:f1a639bc8dd920b4ec08fa488da81ed39bd2ae2f6a48590499ab7f0ad5f8609a`;
