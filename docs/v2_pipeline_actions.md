...
|-------|--------------------|---------|--------------|
| 0. Island universe | `acquire_gshhg.yml` | manual / push to gshhg source | Build the exact island polygons (GSHHG 2.3.7 >= 5 km2, Natural Earth 10m fallback) -> `islands_v2.gpkg` + manifest + source policy. |
