############################################################
## final_TNH_M0_M2_M3_M4_BAYES_light_scenario_comparison_REPRODUCIBLE.R
##
## Purpose
...
OUT_ROOT <- "/Users/rachelzhang/Desktop/final_TNH_M0_M2_M3_M4_BAYES_light_scenario_comparison_REPRODUCIBLE"
...
readme <- c(
  ...
  "", 
  "Main purpose:",
  "Compare M0, M2, M3, M4 as biologically motivated island-syndrome scenarios using Bayesian piecewise path models.",
  "", 
  "Scenario meanings:",
  "M0: geographic filter; distance and island area directly predict floral traits.",
