...
def audit_fine_trait_categories(species_states_parquet: Path, output_dir: Path) -> None:
...
def main() -> None:
    ...
    audit_fine_trait_categories(args.species_states_parquet, args.output_dir)
