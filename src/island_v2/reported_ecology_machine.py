...
PATTERNS: list[tuple[str, str, str]] = [
    ...
    ("mating_system", "predominantly_selfing", r"\b(?:predominantly|mainly) selfing\b"),
    ...
    ("pollen_vector_mode", "mixed", r"\bambophil(?:y|ous)\b"),
    ...
    ("dichogamy", "absent", r"\b(?:no|absent|without) dichogam(?:y|ous)\b"),
    ("dichogamy", "variable", r"\bvariable dichogam(?:y|ous)\b"),
    ...
    ("cleistogamy", "absent", r"\b(?:no|absent|without) cleistogam(?:y|ous)\b"),
    ("herkogamy", "pronounced", r"\b(?:pronounced|strong) herkogam(?:y|ous)\b"),
    ("herkogamy", "reduced", r"\b(?:reduced|weak) herkogam(?:y|ous)\b"),
    ("herkogamy", "absent", r"\b(?:no|absent|without) herkogam(?:y|ous)\b"),
    ...
    ("sex_system", "androdioecious", r"\bandrodioecious\b"),
    ("sex_system", "polygamous_or_other", r"\bpolygamous flowers?\b"),
]
