"""Build the lossless Wave43 overlay from external AusTraits morphology."""
...
BASELINE_FORMAL_ARTIFACT = "wave42-external-bulk-reproduction-33357283159"


def build_wave43_overlay(
    *,
    baseline_csv: Path,
    ...
    summary = build_overlay(
        ...
        contract="wave43_austraits_external_morphology_lossless_overlay_v1",
    )
    ...
    summary["external_source_lineage_policy"] = (
        "normalized_underlying_source_citation_fingerprint"
    )
    summary["checks"]["underlying_source_lineage_guard"] = (
        checkpoint["evidence"]["underlying_source_lineages"] == 5
    )
    output_path = output_dir / "wave43_coverage_summary.json"
