"""Validate the frozen Wave51 Peperomia reproductive packet."""
...
BASELINE_WAVE50_RUN_ID = 33_406_678_174
DIRECT_ROWS = 4
EXTERNAL_ROWS = 2
REVIEW_ROWS = 6
IDENTITY_ROWS = 6
...
def validate_packet(
    *,
    ...
    return validate_reproductive_packet(
        ...
        contract="wave51_peperomia_reproductive_checkpoint_v1",
        baseline_check_label="immediate_wave50_baseline_pinned",
    )
