"""Validate the frozen Wave52 support-two reproductive packet."""
...
BASELINE_WAVE51_RUN_ID = 33_467_582_475
DIRECT_ROWS = 3
EXTERNAL_ROWS = 0
REVIEW_ROWS = 3
IDENTITY_ROWS = 3
...
def validate_packet(
    *,
    ...
    return validate_reproductive_packet(
        ...
        contract="wave52_support_two_reproductive_checkpoint_v1",
        baseline_check_label="immediate_wave51_baseline_pinned",
