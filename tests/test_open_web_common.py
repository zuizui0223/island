...
def test_review_promotion_can_run_on_pr_with_exact_pinned_artifacts() -> None:
    ...
    assert "inputs.prior_public_web_run_id || '31267113911'" in workflow
    assert "reviewed-open-web-evidence-31267113911" in workflow
    ...
    assert "near-rule-source-acquisition-20260809" in workflow
