...
def test_wave45_overlay_uses_exact_reviewed_lineage_and_trait_specific_low(
    tmp_path: Path,
) -> None:
            ...
            baseline_rows.append(
                {
                    ...
                    "axis": axis,
                    "trait_composition": 'self_incompatibility=["SC"]' if low else "",
        ...
        [
            {
                ...
                "quality": "high",
                "state_set": '["SC"]',
                "source_groups": "wave45_primary_reproductive_articles",
                "source_lineages": "doi:10.1234/reviewed",
            },
            {
                "accepted_species": "A alpha",
                "axis": "reproductive_assurance",
                ...
                "resolution_status": "resolved",
                "quality": "high",
                "state_set": '["mixed_mating"]',
                "source_groups": "unreviewed",
                "source_lineages": "doi:10.1234/unreviewed",
            },
        ]
    )
            ...
            [
                {
                    ...
                    "axis": "reproductive_assurance",
                    "trait_name": "self_incompatibility",
                    "source_lineage": "doi:10.1234/reviewed",
                }
            ]
        ),
        direct_csv,
        ...
        json.dumps(
            {
                ...
                "evidence": {"new_external_species_trait": 1},
    ...
    assert summary["delta"]["resolved_wave45_direct_species_trait"] == 1
